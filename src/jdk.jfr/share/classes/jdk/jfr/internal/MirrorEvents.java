...
import jdk.jfr.events.NativeMemoryAllocationEvent;
import jdk.jfr.events.NativeMemoryFreeEvent;
import jdk.jfr.events.NativeMemoryReallocateEvent;
...
final class MirrorEvents {
    ...
    static {
        ...
        register("jdk.internal.event.NativeMemoryAllocationEvent", NativeMemoryAllocationEvent.class);
        register("jdk.internal.event.NativeMemoryFreeEvent", NativeMemoryFreeEvent.class);
        register("jdk.internal.event.NativeMemoryReallocateEvent", NativeMemoryReallocateEvent.class);
