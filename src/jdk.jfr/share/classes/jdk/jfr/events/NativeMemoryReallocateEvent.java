...
@Name(Type.EVENT_NAME_PREFIX + "NativeMemoryReallocate")
@Label("Native Memory Reallocate")
...
public final class NativeMemoryReallocateEvent extends MirrorEvent {
    ...
    @Label("Old Address")
    @Description("Address of the previous native memory block")
    public long oldAddress;
    ...
    @Label("Size")
    @Description("Number of bytes reallocated")
    @DataAmount
    public long size;
}
